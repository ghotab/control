...
// Nivel(es) que pueden usar la carga de Pendientes WF (solo su propia base).
export const NIVELES_AUXILIAR = ["auxiliar", "tecnico", "coordinador"];

// Nivel(es) que ven el universo completo: todas las bases, pendientes Y
// terminadas, con KPIs y filtro de base.
export const NIVELES_JEFE = ["jefe", "gerente"];
...
// --- tbl_base_alias -----------------------------------------------------
// Tabla de catálogo para traducir los nombres "raros"/descriptivos que trae
// tbl_flota.base (p. ej. "MEX OCC") a la clave normalizada de 4 caracteres
// que usan los usuarios en tbl_usuarios.base (p. ej. "TOCC"). Si la tabla no
// existe todavía o una base no está listada ahí, la app hace la comparación
// directa (sin traducir) como respaldo.
export const TABLA_BASE_ALIAS = "tbl_base_alias";
export const COL_ALIAS_NOMBRE = "alias";
export const COL_ALIAS_CLAVE = "clave_base";
...
export const HOJA_MONITOREO_CANDIDATOS = ["BA MonitoreoAutobús", "ASJ BA MonitoreoAutobús"];
...
// abordo" sugiere que ya se compartió/envió. Ajusta esta lista de palabras
// clave si la deducción se equivoca en tus datos reales.
export const PALABRAS_VIDEO_COMPARTIDO = [
  "compart",
  "envi",
  "adjunt",
  "descarg",
